...
class SendSparkTest(BitcoinTestFramework):
    def __init__(self):
        super().__init__()
        self.num_nodes = 4
    ...
    def run_test(self):
        ...
        self.test_sendspark_1transparent_simple()
        self.test_sendspark_1transparent_with_fee()
        self.test_sendspark_1transparent_all()
        self.test_sendspark_2transparent_simple()
        self.test_sendspark_2transparent_with_fee()
        self.test_sendspark_2transparent_all()
        self.test_sendspark_4transparent_all_complex()


        self.test_sendspark_1spark_simple()
        self.test_sendspark_1spark_with_fee()
        self.test_sendspark_1spark_all()
        self.test_sendspark_2spark_simple()
        self.test_sendspark_2spark_with_fee()
        self.test_sendspark_2spark_all()
        self.test_sendspark_4spark_all_complex()

        self.test_sendspark_complex_all_complex()

    def test_sendspark_1transparent_simple(self):
        ...
        txid = self.nodes[0].sendspark({transparent_address: {"amount": expected_amount, "subtractFee": False}})
        self.nodes[0].generate(1)
        self.sync_all()
    ...
    def test_sendspark_1transparent_with_fee(self):
        ...
        transparent_address = self.nodes[0].getnewaddress()
        txid = self.nodes[0].sendspark({transparent_address: {"amount": expected_amount, "subtractFee": True}})
        self.nodes[0].generate(1)
        self.sync_all()
    ...
    def test_sendspark_1transparent_all(self):
        ...
        transparent_address = self.nodes[0].getnewaddress()
        txid = self.nodes[0].sendspark({transparent_address: {"amount": expected_amount, "memo": "test memo", "subtractFee": True}})
        self.nodes[0].generate(1)
        self.sync_all()
    ...
    def test_sendspark_2transparent_simple(self):
    ...
    def test_sendspark_2transparent_with_fee(self):
    ...
    def test_sendspark_2transparent_all(self):
    ...
    def test_sendspark_4transparent_all_complex(self):
    ...
    def test_sendspark_1spark_simple(self):
        ...
        txid = self.nodes[0].sendspark({spark_addr: {"amount": expected_amount, "subtractFee": False}})
        self.nodes[0].generate(1)
        self.sync_all()
    ...
    def test_sendspark_1spark_with_fee(self):
        ...
        spark_addr = self.nodes[0].getnewsparkaddress()[0]
        txid = self.nodes[0].sendspark({spark_addr: {"amount": expected_amount, "subtractFee": True}})
        self.nodes[0].generate(1)
        self.sync_all()
    ...
    def test_sendspark_1spark_all(self):
        ...
        spark_addr = self.nodes[0].getnewsparkaddress()[0]
        txid = self.nodes[0].sendspark({spark_addr: {"amount": expected_amount, "memo": "test memo", "subtractFee": True}})
        self.nodes[0].generate(1)
        self.sync_all()
    ...
    def test_sendspark_2spark_simple(self):
    ...
    def test_sendspark_2spark_with_fee(self):
    ...
    def test_sendspark_2spark_all(self):
    ...
    def test_sendspark_4spark_all_complex(self):
    ...
    def test_sendspark_complex_all_complex(self):
